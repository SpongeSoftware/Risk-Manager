 ...
 * Admins pre-create accounts with just a name and email — no WorkOS ID is needed
 * at creation time. The {@link users.workosId} is linked on the user's first sign-in.
 */
export const users = sqliteTable("users", {
	/** Internal UUID generated by the application, not from WorkOS. */
	id: text("id").primaryKey(),
	/** WorkOS user ID, linked automatically on the user's first sign-in. Null until then. */
